...
'''
>>> print(os.popen('echo test_1.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Eleonore Sanjay
There is no solution.
>>> print(os.popen('echo test_2.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Frank Nina Paul
There are 8 solutions.
>>> print(os.popen('echo test_3.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_4.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Andrew Bill Hilary Nancy
There are 9 solutions.
>>> print(os.popen('echo test_5.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Andrew Bill Gaojian Hilary Nancy
There is no solution.
>>> print(os.popen('echo test_6.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Harry Richard
There are 3 solutions.
>>> print(os.popen('echo test_7.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Harry Richard
There is a unique solution:
Sir Harry is a Knave.
Sir Richard is a Knight.
>>> print(os.popen('echo test_8.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Gaojian Richard
There is a unique solution:
Sir Gaojian is a Knave.
Sir Richard is a Knight.
>>> print(os.popen('echo test_9.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Gaojian Richard
There is a unique solution:
Sir Gaojian is a Knight.
Sir Richard is a Knave.
>>> print(os.popen('echo test_10.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Gaojian Richard
There is a unique solution:
Sir Gaojian is a Knight.
Sir Richard is a Knave.
>>> print(os.popen('echo test_11.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Jenny John Paul
There is a unique solution:
Sir Jenny is a Knight.
Sir John is a Knave.
Sir Paul is a Knave.
>>> print(os.popen('echo test_13.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_14.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_15.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
There is no solution.
>>> print(os.popen('echo test_16.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Arnold Jordan Lam Mae Peggy Rhonda
There is no solution.
>>> print(os.popen('echo test_17.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
There is no solution.
>>> print(os.popen('echo test_18.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_19.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: April Christopher Damian Elmer Gordon Walter
There are 6 solutions.
>>> print(os.popen('echo test_20.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_21.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Brenda Jacqueline Mason Renee
There are 9 solutions.
>>> print(os.popen('echo test_22.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_23.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_24.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_25.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Gagnon Rodriguez Salvador Tiffany Travis
There are 5 solutions.
>>> print(os.popen('echo test_26.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_27.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Bessie Isaac Jackie Patricia
There is no solution.
>>> print(os.popen('echo test_28.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Guy Jim Lily Linda Madison Marion
There is no solution.
>>> print(os.popen('echo test_29.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Daniel Harvey Jake Jonathan Regina Wade
There is no solution.
>>> print(os.popen('echo test_30.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_31.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_32.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Casey Isla Lillian Marshall Ramon Roberts Sue Sullivan
There is no solution.
>>> print(os.popen('echo test_33.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_34.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
There is no solution.
>>> print(os.popen('echo test_35.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_36.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Carolyn Ernest Jones Lydia Sue Viola
There are 7 solutions.
>>> print(os.popen('echo test_37.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
There is no solution.
>>> print(os.popen('echo test_38.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Billy Cecil Deanna Hilda Jon Mark Terry Willard
There is no solution.
>>> print(os.popen('echo test_39.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Claude Ernest Martha Theodore Warren
There are 17 solutions.
>>> print(os.popen('echo test_40.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_41.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Bruce Chris Laura Maurice Raul
There are 2 solutions.
>>> print(os.popen('echo test_42.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
>>> print(os.popen('echo test_43.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Antonio Cecil Georgia Irma Johnson Vivian
There are 2 solutions.
>>> print(os.popen('echo test_44.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
...
There is no solution.
>>> print(os.popen('echo test_49.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
Which text file do you want to use for the puzzle? The Sirs are: Brad David Erin Marsha Michael Pamela Wade
There are 11 solutions.
>>> print(os.popen('echo test_50.txt | python3 knights_and_knaves_ruby.py').read(), end = '')
