...
class TuringMachineSimulator(tk.Tk):
    ...
    def program_help(self):
        tkinter.messagebox.showinfo('Program',
            ...
            'where state_1 and state_2 have to be alphanumeric words with at most 8 characters, '
            'bit_1 and bit_2 have to be 0 or 1, and dir has to be L or R.\n\n'
            'When the TM machine is in state state_1 with its head pointing to a cell containing '
            'bit_1, then it changes bit_1 to bit_2 in that cell, modifies its state to state_2, '
            'and moves its head one cell to the right or to the left as determined by dir.\n\n'
            'The TM machine is supposed to be deterministic, hence the program should not contain '
            'two instructions starting with the same pair (state_1, bit_1).\n\n'
